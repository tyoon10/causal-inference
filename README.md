...
Interactive single-page study module covering causal inference fundamentals, built for mid-term exam preparation at Columbia Business School.
...
- **Method Comparison** — decision framework for choosing the right estimator

## Features

- Interactive canvas visualizations (propensity score overlap, PS sufficiency, IPW vs BDA, breakdown point)
